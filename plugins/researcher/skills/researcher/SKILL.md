...
<div class="footer">
  ...
  Generated: [Date]
  <div class="signature">
    <a href="https://github.com/jontsai/claude-plugins" target="_blank">Researcher</a> — Claude Code plugin by <a href="https://github.com/jontsai" target="_blank">jontsai</a>
  </div>
</div>
```
...
2. Create `$RESEARCHER_DIR/html/python-web-frameworks-20251212.html`
3. Run `research-pdf-generate`
4. PDF appears at `$RESEARCHER_DIR/pdf/python-web-frameworks-20251212.pdf`
